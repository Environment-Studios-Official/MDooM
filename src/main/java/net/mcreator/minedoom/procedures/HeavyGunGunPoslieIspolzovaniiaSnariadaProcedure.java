...
public class HeavyGunGunPoslieIspolzovaniiaSnariadaProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getDamageValue() == 0 && new Object() {
			...
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(MinedoomModItems.HEAVY_GUN_GUN.get());
				_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
			}
			MinedoomMod.queueServerWork(3, () -> {
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(MinedoomModItems.HEAVY_GUN_ITEM.get());
